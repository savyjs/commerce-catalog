...
export interface ApiPostalCodePostalCode extends Schema.CollectionType {
  ...
  attributes: {
    postalCode: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product_prices: Attribute.Relation<
      'api::product.product',
      'oneToMany',
    ...
    product_saleabilities: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::product-saleability.product-saleability'
    >;
    product_deliverabilities: Attribute.Relation<
      'api::product.product',
      'oneToMany',
      'api::product-deliverability.product-deliverability'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductDeliverabilityProductDeliverability
  extends Schema.CollectionType {
  collectionName: 'product_deliverabilities';
  info: {
    singularName: 'product-deliverability';
    pluralName: 'product-deliverabilities';
    displayName: 'Product Deliverability';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    storeId: Attribute.Integer & Attribute.Required;
...
export interface ApiProductPriceProductPrice extends Schema.CollectionType {
...
export interface ApiProductSaleabilityProductSaleability
  extends Schema.CollectionType {
  collectionName: 'product_saleabilities';
  info: {
    singularName: 'product-saleability';
    pluralName: 'product-saleabilities';
    displayName: 'Product Saleability';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    from: Attribute.Date;
    till: Attribute.Date;
    isSaleable: Attribute.Boolean;
    isNotSaleable: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::product-saleability.product-saleability',
...
export interface ApiShippingMethodShippingMethod extends Schema.CollectionType {
  ...
  attributes: {
    ...
    zones: Attribute.Relation<
      ...
      'api::zone.zone'
    >;
    weekDay: Attribute.Component<'timedate-units.week-day', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::shipping-method.shipping-method',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::product-deliverability.product-deliverability': ApiProductDeliverabilityProductDeliverability;
      ...
      'api::product-saleability.product-saleability': ApiProductSaleabilityProductSaleability;
